...
/**
 * Edición de ejercicio (`docs/screens.md` §4, RF-001). En esta fase, sin
 * grupos de equipo (Fase 2): solo el nombre.
 */
...
export function ExerciseForm({ initialName = "", submitLabel, onSubmit, onCancel }: ExerciseFormProps) {
